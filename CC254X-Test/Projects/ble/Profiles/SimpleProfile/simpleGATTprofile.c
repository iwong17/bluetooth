 ...
 * CONSTANTS
 */
#define GUA_ATTRTBL_CHAR4_VALUE_IDX             11  //WY 17.8.23ÐÞ¸Ä Ôö¼ÓÁ½¸öÍ¨Öª¿ª¹ØµÄºê     
...
//parameter:        nGUA_ConnHandle: Á¬½Ó¾ä±ú   
//                  npGUA_Value: ÒªÍ¨ÖªµÄÊý¾Ý,·¶Î§Îª0~SIMPLEPROFILE_CHAR6,×î¶à20¸ö×Ö½Ú   
//                  nGUA_Len: ÒªÍ¨ÖªµÄÊý¾ÝµÄ³¤¶È    
//return:           none               
//author:                                                      
