...
//×Ô¶¨ÒåÊÂ¼þ  
#define SBP_RF_COMMUNICAION_PROCESS_EVT               0x0008  //Í¨ÐÅ´¦ÀíÊÂ¼þ  
#define SBP_RF_COMMUNICAION_COMMAND_ERR_EVT           0x0010  //Í¨ÐÅÊý¾Ý³ö´íÊÂ¼þ  
#define SBP_LED_ON_OFF_EVT                            0x0020  //led¿ª¹ØÊÂ¼þ
#define NpiSerial_EVT                                 0x0040  //´®¿ÚÊÂ¼þ
#define SBP_UPDATE_SCAN_RSP_DATA_EVT                  0x0080  //¸ü¸Ä¹ã²¥Éè±¸ÃûÊÂ¼þ
